...
def main():
    ...
    print("\n" + "#" * 70)
    print("  G-F Consistency Framework - Complete Analysis Pipeline")
    print("#" * 70)
    if args.run_human:
    ...
    if args.start_from <= 18 and not args.skip_extended:
